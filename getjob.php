...
<body>
  ...
  <!-- creating heading of dashboard -->
    <div class=" py-3 text-white" style="background-color: #484854">
      <h1>&nbsp;&nbsp;<i class="fas fa-file-invoice-dollar "></i> Get a Job</h1>
    </div>
  ...
  <div class="container-fluid">
    ...
    <div class="row"> 
      <div class="col-8">
        <h2 style="background-color: #FFBB33;" class="text-white p-2 ">Latest Posts</h2>
        <div class="container">
        <!-- creating table -->
        <table class="table mt-3 animated zoomIn slower ">
          ...
          <tbody>
            <tr>
              ...
              <td>200 INR</td>
              <td><a href="3rdlayer.html" class="btn btn-outline-warning btn-sm">
                 Details <i></i>
              </a></td>
            </tr>
            <tr>
              ...
              <td>300 INR</td>
              <td><a href="#" class="btn btn-outline-warning btn-sm">
                 Details <i></i>
              </a></td>
            </tr>
            <tr>
      ...
      <div class="col-md-4 mt-4">
          ...
          <div class="card mt-5">
            <div class=" bg-success text-white p-4 ">
              ...
              <h2 class="float-right font-weight-bold" style="font-size: 50px; text-align: center;">20 <span class="d-block">Bids Offerd</span></h2>
            </div>
